...
namespace Redirection
{
    public static class Utilities
    {
        ...
        /// <summary>
        ///     Gets angle from prevDir to currDir in degrees, assuming the vectors lie in the xz plane (with left handed
        ///     coordinate system).
        /// </summary>
        ...
        public static Vector2 RotateVector(Vector2 fromOrientation, float thetaInDegrees)
        {
            ...
            var cos = Mathf.Cos(-thetaInDegrees * Mathf.Deg2Rad);
            var sin = Mathf.Sin(-thetaInDegrees * Mathf.Deg2Rad);
